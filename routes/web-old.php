...
Route::get('/migrate', function(){
    // $toBeMoved  =  \App\News::all();
    // foreach($toBeMoved as $item){
    //     $saveHere = new \App\Article();
    //     $saveHere['title'] = $item->title;
    //     $saveHere['slug'] = Str::slug($item->title);
    //     $saveHere['author'] = $item->authorname;
    //     $saveHere['date'] = $item->newsdate.' 14:19:00';
    //     $saveHere['body'] = $item->description;
    //     $saveHere['cover'] = 'articles/December2019/'.$item->image;
    //     $saveHere->save();
    //  }
    //  return 'done';
